...
const AddDuty = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!dutyTitle || !deadline || !totalGrade || !groupCode || !pdfFile) {
        ...
        try {
            ...
            const response = await fetch(
                "https://apis.mr-biology.com/admin/duties/addDuty",
                {
                    method: "POST",
                    body: formData,
                }
            ...
            if (data.message === "تم إضافة الواجب بنجاح") {
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span className="text-gray-200">اسحب الملف أو اضغط للرفع</span>
                            <input
                                id="pdf_file"
                                type="file"
